...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item È entrato nella rete isolata della centrale nucleare di Natanz tramite una **chiavetta USB**.
        \item \textbf{Obiettivo:} Attaccare i PLC di controllo delle centrifughe (Siemens).
    \end{itemize}

    \item \textbf{Domino's Pizza}:
    \begin{itemize}
        \item L'app per smartphone gestiva tutto il processing, **senza un double-check lato server**.
...
\begin{itemize}
    ...
    \item \textbf{Normative (EU):} Dal 2022 in Europa è presente la **NIS2** (Network and Information Security 2). Ha l'obiettivo di aumentare il livello di sicurezza in settori critici (energia, sanità, PA, ecc.) imponendo obblighi di gestione del rischio.
